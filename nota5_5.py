import cirq
import numpy as np
###OPERANDOS: x = [x3, x2, x1, x0], y = [y3, y2, y1, y0], a = [a3, a2, a1, a0], OPERACIÓN = a·x + y
x = [1,1,0,1]
y = [1,0,1,1]
a = [0,1,1,1]
y0, y1, y2, y3, x0, x1, x2, x3, a0, a1, a2, a3 = cirq.LineQubit.range(12)
adder = cirq.Circuit()
###INICIALIZACIÓN###
if y[0] == 1:
...
if a[0] == 1:
    adder.append(cirq.X(a3))
if a[1] == 1:
    adder.append(cirq.X(a2))
if a[2] == 1:
...
CCR2 = CR2.controlled()
CCR3 = CR3.controlled()
adder.append([CCR0(a0,x3,y3),CCR1(a0,x2,y3),CCR0(a1,x2,y3),CCR2(a0,x1,y3),
              CCR1(a1,x1,y3),CCR0(a2,x1,y3),CCR3(a0,x0,y3),CCR2(a1,x0,y3),
              CCR1(a2,x0,y3),CCR0(a3,x0,y3)])
adder.append([CCR0(a0,x2,y2),CCR1(a0,x1,y2),CCR0(a1,x1,y2),CCR2(a0,x0,y2),
              CCR1(a1,x0,y2),CCR0(a2,x0,y2)])
